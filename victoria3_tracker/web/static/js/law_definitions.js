/**
 * Victoria 3 Law Definitions — JS mirror of parser/law_definitions.py
 *
 * Add new laws / groups here when Paradox releases DLC/patches.
 * Structure mirrors the Python LAW_GROUPS dict exactly.
 */
...
for (const [groupKey, group] of Object.entries(LAW_GROUPS)) {
    for (const [lawKey, label] of Object.entries(group.laws)) {
        LAW_TO_GROUP[lawKey] = groupKey;
        LAW_LABELS[lawKey] = label;
    }
}
